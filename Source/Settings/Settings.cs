...
public class Settings : ModSettings
{
	...
	public void DoWindowContents(Rect inRect)
	{
		...
		if (AddSimpleSetting(ls, typeof(Need_KillThirst)))
			OverflowStats_DrainGain<Need_KillThirst>.AddSettings(ls);
